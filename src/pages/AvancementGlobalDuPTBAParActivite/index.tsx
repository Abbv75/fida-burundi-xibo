...
interface AvancementGlobalDuPTBAParActiviteProps {
    API_mobile_activiteData: API_mobile_activite_T[];
    nbrPage?: number;
}

const AvancementGlobalDuPTBAParActivite = ({ API_mobile_activiteData, nbrPage }: AvancementGlobalDuPTBAParActiviteProps) => {
    return (
        <Stack sx={{ gap: 3, p: 3 }}>
            <Typography
                level="h4"
...
export default AvancementGlobalDuPTBAParActivite;
