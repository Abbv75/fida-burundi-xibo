...
interface AvancementGlobalDuPTBAParProgrammeProps {
    API_mobile_programmeData: API_mobile_activite_T[];
    nbrPage?: number;
}

const AvancementGlobalDuPTBAParProgramme = ({ API_mobile_programmeData, nbrPage }: AvancementGlobalDuPTBAParProgrammeProps) => {
    return (
        <Stack sx={{ gap: 3, p: 3 }}>
            <Typography
                level="h4"
...
export default AvancementGlobalDuPTBAParProgramme;
